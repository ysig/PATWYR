...
class PATWYR(object):
    ...
    def metrics(self, hypo, ref):
        ...
        wer, cer = fastwer.score(hypo, ref), fastwer.score(hypo, ref, char_level=True)
        return wer, cer
    ...
    def train(self, annotation_txt, image_folder, epochs, lr, lr_decay, batch_size, num_workers, pin_memory, smoothing_eps):
